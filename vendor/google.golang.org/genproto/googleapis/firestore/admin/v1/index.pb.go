...
func (Index_QueryScope) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_index_b0b123c59ebcd9bf, []int{0, 0}
}
...
func (Index_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_index_b0b123c59ebcd9bf, []int{0, 1}
}
...
func (Index_IndexField_Order) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_index_b0b123c59ebcd9bf, []int{0, 0, 0}
}
...
func (Index_IndexField_ArrayConfig) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_index_b0b123c59ebcd9bf, []int{0, 0, 1}
}
...
func (*Index) Descriptor() ([]byte, []int) {
	return fileDescriptor_index_b0b123c59ebcd9bf, []int{0}
}
...
func init() {
	proto.RegisterFile("google/firestore/admin/v1/index.proto", fileDescriptor_index_b0b123c59ebcd9bf)
}

var fileDescriptor_index_b0b123c59ebcd9bf = []byte{
