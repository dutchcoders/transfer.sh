...
func (*WebhookRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_webhook_20ed083b708a05f3, []int{0}
}
...
func (*WebhookResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_webhook_20ed083b708a05f3, []int{1}
}
...
func (*OriginalDetectIntentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_webhook_20ed083b708a05f3, []int{2}
}
...
func init() {
	proto.RegisterFile("google/cloud/dialogflow/v2/webhook.proto", fileDescriptor_webhook_20ed083b708a05f3)
}

var fileDescriptor_webhook_20ed083b708a05f3 = []byte{
