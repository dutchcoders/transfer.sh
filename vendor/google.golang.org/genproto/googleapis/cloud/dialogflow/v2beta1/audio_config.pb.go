...
func (SsmlVoiceGender) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_audio_config_b382467f1f4a00bc, []int{0}
}
...
func (OutputAudioEncoding) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_audio_config_b382467f1f4a00bc, []int{1}
}
...
func (*OutputAudioConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_audio_config_b382467f1f4a00bc, []int{2}
}
...
func init() {
	proto.RegisterFile("google/cloud/dialogflow/v2beta1/audio_config.proto", fileDescriptor_audio_config_b382467f1f4a00bc)
}

var fileDescriptor_audio_config_b382467f1f4a00bc = []byte{
