...
func (*KnowledgeBase) Descriptor() ([]byte, []int) {
	return fileDescriptor_knowledge_base_b7def7a9557ab6ab, []int{0}
}
...
func (*ListKnowledgeBasesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_knowledge_base_b7def7a9557ab6ab, []int{1}
}
...
func (*ListKnowledgeBasesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_knowledge_base_b7def7a9557ab6ab, []int{2}
}
...
func (*GetKnowledgeBaseRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_knowledge_base_b7def7a9557ab6ab, []int{3}
}
...
func (*CreateKnowledgeBaseRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_knowledge_base_b7def7a9557ab6ab, []int{4}
}
...
func (*DeleteKnowledgeBaseRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_knowledge_base_b7def7a9557ab6ab, []int{5}
}
...
func init() {
	proto.RegisterFile("google/cloud/dialogflow/v2beta1/knowledge_base.proto", fileDescriptor_knowledge_base_b7def7a9557ab6ab)
}

var fileDescriptor_knowledge_base_b7def7a9557ab6ab = []byte{
