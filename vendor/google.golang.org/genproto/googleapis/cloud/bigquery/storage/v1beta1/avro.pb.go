...
func (*AvroSchema) Descriptor() ([]byte, []int) {
	return fileDescriptor_avro_a80787838e5f728e, []int{0}
}
...
func (*AvroRows) Descriptor() ([]byte, []int) {
	return fileDescriptor_avro_a80787838e5f728e, []int{1}
}
...
func init() {
	proto.RegisterFile("google/cloud/bigquery/storage/v1beta1/avro.proto", fileDescriptor_avro_a80787838e5f728e)
}

var fileDescriptor_avro_a80787838e5f728e = []byte{
