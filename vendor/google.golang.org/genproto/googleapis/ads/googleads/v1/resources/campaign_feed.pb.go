...
func (*CampaignFeed) Descriptor() ([]byte, []int) {
	return fileDescriptor_campaign_feed_059fb8e27cec7d36, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/resources/campaign_feed.proto", fileDescriptor_campaign_feed_059fb8e27cec7d36)
}

var fileDescriptor_campaign_feed_059fb8e27cec7d36 = []byte{
