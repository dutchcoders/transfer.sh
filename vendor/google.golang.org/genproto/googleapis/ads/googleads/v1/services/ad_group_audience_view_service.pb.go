...
func (*GetAdGroupAudienceViewRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad_group_audience_view_service_352fe7a395704ceb, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/services/ad_group_audience_view_service.proto", fileDescriptor_ad_group_audience_view_service_352fe7a395704ceb)
}

var fileDescriptor_ad_group_audience_view_service_352fe7a395704ceb = []byte{
