...
func (*GetCustomerClientLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_client_link_service_1e663bab1293db02, []int{0}
}
...
func (*MutateCustomerClientLinkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_client_link_service_1e663bab1293db02, []int{1}
}
...
func (*CustomerClientLinkOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_client_link_service_1e663bab1293db02, []int{2}
}
...
func (*MutateCustomerClientLinkResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_client_link_service_1e663bab1293db02, []int{3}
}
...
func (*MutateCustomerClientLinkResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_client_link_service_1e663bab1293db02, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/services/customer_client_link_service.proto", fileDescriptor_customer_client_link_service_1e663bab1293db02)
}

var fileDescriptor_customer_client_link_service_1e663bab1293db02 = []byte{
