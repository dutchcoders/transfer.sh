...
func (*GetFeedItemRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_1b4b109b4ccb794d, []int{0}
}
...
func (*MutateFeedItemsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_1b4b109b4ccb794d, []int{1}
}
...
func (*FeedItemOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_1b4b109b4ccb794d, []int{2}
}
...
func (*MutateFeedItemsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_1b4b109b4ccb794d, []int{3}
}
...
func (*MutateFeedItemResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_service_1b4b109b4ccb794d, []int{4}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/services/feed_item_service.proto", fileDescriptor_feed_item_service_1b4b109b4ccb794d)
}

var fileDescriptor_feed_item_service_1b4b109b4ccb794d = []byte{
