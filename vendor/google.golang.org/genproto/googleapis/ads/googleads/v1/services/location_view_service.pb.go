...
func (*GetLocationViewRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_location_view_service_4136922ee54aedcd, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/services/location_view_service.proto", fileDescriptor_location_view_service_4136922ee54aedcd)
}

var fileDescriptor_location_view_service_4136922ee54aedcd = []byte{
