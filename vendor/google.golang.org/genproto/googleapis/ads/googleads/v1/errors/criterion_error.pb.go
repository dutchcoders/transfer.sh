...
func (CriterionErrorEnum_CriterionError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_criterion_error_97fe7dbbbafb83b2, []int{0, 0}
}
...
func (*CriterionErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_criterion_error_97fe7dbbbafb83b2, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/criterion_error.proto", fileDescriptor_criterion_error_97fe7dbbbafb83b2)
}

var fileDescriptor_criterion_error_97fe7dbbbafb83b2 = []byte{
