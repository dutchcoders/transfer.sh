...
func (ExtensionSettingErrorEnum_ExtensionSettingError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_extension_setting_error_8dcb14fad85d40b8, []int{0, 0}
}
...
func (*ExtensionSettingErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_extension_setting_error_8dcb14fad85d40b8, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/extension_setting_error.proto", fileDescriptor_extension_setting_error_8dcb14fad85d40b8)
}

var fileDescriptor_extension_setting_error_8dcb14fad85d40b8 = []byte{
