...
func (MediaFileErrorEnum_MediaFileError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_media_file_error_5054e1ce0cb81f20, []int{0, 0}
}
...
func (*MediaFileErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_media_file_error_5054e1ce0cb81f20, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/media_file_error.proto", fileDescriptor_media_file_error_5054e1ce0cb81f20)
}

var fileDescriptor_media_file_error_5054e1ce0cb81f20 = []byte{
