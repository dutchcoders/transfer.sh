...
func (FeedErrorEnum_FeedError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_feed_error_1af0fcf72a28b53c, []int{0, 0}
}
...
func (*FeedErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_error_1af0fcf72a28b53c, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/feed_error.proto", fileDescriptor_feed_error_1af0fcf72a28b53c)
}

var fileDescriptor_feed_error_1af0fcf72a28b53c = []byte{
