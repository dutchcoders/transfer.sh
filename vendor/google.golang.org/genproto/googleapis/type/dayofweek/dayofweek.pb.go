...
func (DayOfWeek) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_dayofweek_51230d4206be2e28, []int{0}
}
...
func init() {
	proto.RegisterFile("google/type/dayofweek.proto", fileDescriptor_dayofweek_51230d4206be2e28)
}

var fileDescriptor_dayofweek_51230d4206be2e28 = []byte{
