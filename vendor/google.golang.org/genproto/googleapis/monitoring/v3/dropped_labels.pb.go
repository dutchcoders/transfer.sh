...
func (*DroppedLabels) Descriptor() ([]byte, []int) {
	return fileDescriptor_dropped_labels_c5acb2f32342b6c7, []int{0}
}
...
func init() {
	proto.RegisterFile("google/monitoring/v3/dropped_labels.proto", fileDescriptor_dropped_labels_c5acb2f32342b6c7)
}

var fileDescriptor_dropped_labels_c5acb2f32342b6c7 = []byte{
